...
public class InputSelection : MonoBehaviour
{
    ...
    protected void BindInputToPlayer()
    {
        ...
        else if (Input.GetButton("J1PS4_DownButton") && !Settings.inputAssigned[1])
        {
        ...
        else if (Input.GetButton("J2PS4_DownButton") && !Settings.inputAssigned[2])
        {
        ...
        else if(Input.GetButton("J3PS4_DownButton") && !Settings.inputAssigned[3])
        {
        ...
        else if (Input.GetButton("J1XBOX_DownButton") && !Settings.inputAssigned[1])
        {
        ...
        else if (Input.GetButton("J2XBOX_DownButton") && !Settings.inputAssigned[2])
        {
        ...
        else if (Input.GetButton("J3XBOX_DownButton") && !Settings.inputAssigned[3])
        {
